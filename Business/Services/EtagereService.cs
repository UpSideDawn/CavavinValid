...
namespace Business.Services
{
    ...
    // private readonly IConfiguration _configuration;
      ...
      //    _configuration = configuration;
        ...
        public async Task<ActionResult<IEnumerable<EtagereDTO>>>RecupererListeEtagere()
        {
            ActionResult<IEnumerable<Etagere>> etagereModelResultat = null;               //Definit une variable de type Task<ActionResult> (Meme type que le retour de GetAllEtagere)
            ...
            using (VinContext _context = new VinContext(_optionsBuilder.Options))               //Initialise une variable valable uniquement entre les cotes
            {
               ...
               return etagereModelResultat.Adapt<ActionResult<IEnumerable<EtagereDTO>>>();
